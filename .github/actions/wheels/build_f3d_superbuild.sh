...
# openh264 is build shared because of https://github.com/f3d-app/f3d-superbuild/issues/370
# ffmpeg is build shared because it's LGPL
cmake -S ./source -B ./fsbb           \
  -DBUILD_SHARED_LIBS=OFF             \
  -DBUILD_SHARED_LIBS_ffmpeg=ON       \
