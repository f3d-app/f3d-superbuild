...
if (cpack_generator MATCHES "DragNDrop")
  ...
  option(F3D_PACKAGING_HDUTIL_WORKAROUND "Unsafe workaround for hdiutil failures" OFF)
  if (F3D_PACKAGING_HDUTIL_WORKAROUND)
    set(CPACK_COMMAND_HDIUTIL "${CMAKE_CURRENT_LIST_DIR}/files/hdiutil_repeat.sh")
  else()
    set(CPACK_COMMAND_HDIUTIL "hdiutil")
  endif()
endif()
